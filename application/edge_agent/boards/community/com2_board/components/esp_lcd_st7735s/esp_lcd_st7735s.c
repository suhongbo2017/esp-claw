...
#include "esp_lcd_types.h"       /* esp_lcd_panel_handle_t typedef */
...
/* ── Init-command table ─────────────────────────────────────────────────── */
#define MAX_INIT_DATA 16

typedef struct {
    uint8_t cmd;
    uint8_t data[MAX_INIT_DATA];
    uint8_t len;
    uint32_t delay_ms;
} init_cmd_t;
...
static const init_cmd_t s_init_cmds[] = {
    {0x01, {}, 0, 20},
    {0x11, {}, 0, 120},
    {0xB1, {0x00, 0x1B, 0x08}, 3, 0},
    {0xC0, {0x0D, 0x01, 0x02, 0x02}, 4, 0},
    {0xC1, {0x40, 0x81}, 2, 0},
    {0xC5, {0x30, 0x30}, 2, 0},
    {0xC8, {0x00,0x32,0x36,0x3D,0x3E,0x2C,0x29,0x2E,0x30,0x30,0x38,0x3B}, 12, 0},
    {0x3A, {0x55}, 1, 0},
    {0x2A, {0x00, 0x00, 0x00, 0x7F}, 4, 0},
    {0x2B, {0x00, 0x00, 0x00, 0x9F}, 4, 0},
    {0x29, {}, 0, 120},
};

/* Send init commands with MADCTL injection */
